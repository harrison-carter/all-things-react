  ...
  return (
    ...
    >
      <p className="text-sm text-zinc-400">
        The <code className="text-zinc-300">useFormMutation</code> hook syncs
        mutation status into one Zustand store, while{" "}
        <code className="text-zinc-300">useNavbarSlot</code> sets the active
        slot type in another. The layout reads from both stores to decide what
        to render — no shared provider needed.
      </p>
