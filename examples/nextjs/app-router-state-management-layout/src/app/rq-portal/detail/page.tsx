...
export default function RQPortalDetailPage() {
  return (
    <>
      <PortalInject>
        <BackLink href="/rq-portal/form" label="Back to form" />
      </PortalInject>
      <div className="space-y-4">
        <p className="text-sm text-zinc-400">
          This page portals a{" "}
          <strong className="text-zinc-300">back link</strong> into the
          layout&apos;s slot. No React Query hooks are involved — the back link
          is purely static. Portals handle everything here on their own.
        </p>
