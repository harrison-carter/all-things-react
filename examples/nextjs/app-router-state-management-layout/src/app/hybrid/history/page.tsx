    ...
    <>
      ...
      <div className="space-y-4">
        <p className="text-sm text-zinc-400">
          ...
          navbar slot. Like the detail page, no store is needed — the buttons
          are self-contained. The Zustand store only comes into play for pages
          that have cross-component state (like the form&apos;s mutation
          status).
        </p>
