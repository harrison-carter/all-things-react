...
export default function PortalDetailPage() {
  return (
    <>
      <PortalInject>
        <BackLink href="/portal/form" label="Back to form" />
      </PortalInject>
      <div className="space-y-4">
        <p className="text-sm text-zinc-400">
          This page portals a{" "}
          <strong className="text-zinc-300">back link</strong> into the
          layout&apos;s slot — the same{" "}
          <code className="text-zinc-300">PortalInject</code> mechanism, just
          with different children. No extra providers or stores needed.
        </p>
